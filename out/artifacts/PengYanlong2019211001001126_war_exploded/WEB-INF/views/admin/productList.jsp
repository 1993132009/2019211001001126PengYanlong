<%@ page import="com.Pengyanlong.model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.Pengyanlong.model.Category" %>
		...
		<div class="table-responsive col-sm-10">
			...
			<c:forEach var="p" items="${productList}">
				<tr>
					...
					<%
						com.Pengyanlong.model.Product p=(com.Pengyanlong.model.Product)pageContext.findAttribute("p");
						int pid=p.getProductId()+28;
